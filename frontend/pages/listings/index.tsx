                ...
                <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                    <ul role="list" className="divide-y divide-gray-500">
                        {Array.isArray(data) && data.length > 0 ? (
                            data.map((param) => (
                            <Link key={param['Id']} className="flex justify-between gap-x-6 py-8 hover:bg-gray-700 rounded-3xl" href={'listings/property/'+param['Id']}>
                                <div className="flex min-w-0 gap-x-4 ml-10">
                                    <img className="h-12 w-12 flex-none" src={"https://www.pinclipart.com/picdir/big/387-3872576_purple-home-5-icon-free-icons-house-with.png"}
                                         alt=""/>
                                    <div className="min-w-0 flex-auto">
                                        <p className="text-md font-semibold leading-6">{param['Property.Address.AddressText']}</p>
                                        <a className="text-md font-semibold leading-5 text-fuchsia-800" href={"https://www.realtor.ca/"+param['RelativeURLEn']}> See More...</a>
                            ...
                            <main className="grid min-h-full place-items-center bg-gray-800 px-6 py-24 sm:py-32 lg:px-8">
                                <div className="text-center">
                                    ...
                                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-100 sm:text-5xl">Server Error</h1>
                                    <p className="mt-6 text-base leading-7 text-gray-300">Sorry, we couldn’t retrieve any data.</p>
